...
export function BallotIcon({ size = 20 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
...
export function GridViewIcon({ size = 20 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
...
export function CardDeckIcon({ size = 20 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
      ...
      aria-hidden
    >
      <rect x="7.5" y="4" width="9" height="16" rx="1.5" />
...
export function UserPlusIcon({ size = 18 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
...
export function UserMinusIcon({ size = 18 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
